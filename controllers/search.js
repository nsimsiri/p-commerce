...
module.exports = function(){
    ...
    var assignCriteriaFromRequestQuery=function(query){
        // if criteria not specifically mentioned, assign every criteria
        var criteria = (query.criteria) ? query.criteria : CRITERIA_ALL
        if (query.categoryId){
    ...
    router.get('/', function(req, res){
        ...
        req.query.criteria = assignCriteriaFromRequestQuery(req.query)
